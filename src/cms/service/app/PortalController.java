  ...
  /**
    ...
    */
        ...
        throws ServletException, IOException
    {
        ...
        String portalctions="sampleportal samplesetup  sampleofficeview travelschedule travelbooking traveladmin";
        ...
        baseurl=baseurl.replace("/portal", "");
        ...
        */
        ...
        if(access!=null && tu.isEmptyValue(useraction)){            
           ...
           strNextPage="/src/index.jsp?username="+username+"&refobjid="+refobjid
        ...
        }else if(access!=null && !tu.isEmptyValue(useraction) && portalctions.contains(useraction)){            
               logger.info("\n"+date.toString()+" Loged in User:="+username+" "+":-Assigned Token="+access.getToken() +":-refobjid="+refobjid);
               //access token is appended with Client IP in the indexpage
               strNextPage="/src/portal/"+useraction+".jsp?username="+username+"&refobjid="+refobjid
            		   +"&usertoken="+access.getToken()+CONST.IPSEPERATOR+remoteaddress
            		   +CONST.IPSEPERATOR+username+"&baseurl="+baseurl+"&mqid="+access.getMessageque(); 
       	 ...
       	 strNextPage="/src/campaign/"+useraction+".jsp?username="+username+"&firstname="+access.getFirstname()+"&usertoken="+access.getToken()+CONST.IPSEPERATOR+remoteaddress+CONST.IPSEPERATOR+username+"&baseurl="
       	           +baseurl+"&campaignid="+refobjid+"&sendreference="+sendreference;
